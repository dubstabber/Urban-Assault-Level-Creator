...
func _update_properties() -> void:
	if EditorState.selected_unit is HostStation:
		...
		%XposHostStationLineEdit.text = str(round(EditorState.selected_unit.position.x))
		%YposHostStationLineEdit.text = str(EditorState.selected_unit.pos_y)
		%ZposHostStationLineEdit.text = str(round(-EditorState.selected_unit.position.y))
